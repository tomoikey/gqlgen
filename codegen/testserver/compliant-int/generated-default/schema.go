...
func (ec *executionContext) _marshalOResult2ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋcodegenᚋtestserverᚋcompliantᚑintᚋgeneratedᚑdefaultᚐResultWithFields(ctx context.Context, fields []graphql.CollectedField, v *Result) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
...
func (ec *executionContext) _marshalOResult642ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋcodegenᚋtestserverᚋcompliantᚑintᚋgeneratedᚑdefaultᚐResult64WithFields(ctx context.Context, fields []graphql.CollectedField, v *Result64) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
