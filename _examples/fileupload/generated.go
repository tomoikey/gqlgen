...
func (ec *executionContext) _File(ctx context.Context, sel ast.SelectionSet, obj *model.File) graphql.Marshaler {
	...
	return ec._marshalFile(ctx, fields, obj)
}

func (ec *executionContext) _marshalFile(ctx context.Context, fields []graphql.CollectedField, obj *model.File) graphql.Marshaler {
...
func (ec *executionContext) _marshalNFile2githubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋfileuploadᚋmodelᚐFileWithFields(ctx context.Context, fields []graphql.CollectedField, v model.File) graphql.Marshaler {
	return ec._marshalFile(ctx, fields, &v)
}
...
func (ec *executionContext) marshalNFile2ᚕᚖgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋfileuploadᚋmodelᚐFileᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.File) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, fileImplementors)
	return ec._marshalNFile2ᚕᚖgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋfileuploadᚋmodelᚐFileᚄWithFields(ctx, fields, v)
}

func (ec *executionContext) _marshalNFile2ᚕᚖgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋfileuploadᚋmodelᚐFileᚄWithFields(ctx context.Context, fields []graphql.CollectedField, v []*model.File) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec._marshalNFile2ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋfileuploadᚋmodelᚐFileWithFields(ctx, fields, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) _marshalNFile2ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋfileuploadᚋmodelᚐFileWithFields(ctx context.Context, fields []graphql.CollectedField, v *model.File) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
