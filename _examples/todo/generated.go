...
func (ec *executionContext) _marshalNTodo2githubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋtodoᚐTodoWithFields(ctx context.Context, fields []graphql.CollectedField, v Todo) graphql.Marshaler {
...
func (ec *executionContext) marshalNTodo2ᚕᚖgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋtodoᚐTodoᚄ(ctx context.Context, sel ast.SelectionSet, v []*Todo) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, todoImplementors)
	return ec._marshalNTodo2ᚕᚖgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋtodoᚐTodoᚄWithFields(ctx, fields, v)
}

func (ec *executionContext) _marshalNTodo2ᚕᚖgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋtodoᚐTodoᚄWithFields(ctx context.Context, fields []graphql.CollectedField, v []*Todo) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec._marshalNTodo2ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋtodoᚐTodoWithFields(ctx, fields, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) _marshalNTodo2ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋtodoᚐTodoWithFields(ctx context.Context, fields []graphql.CollectedField, v *Todo) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) _marshalOTodo2ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋtodoᚐTodoWithFields(ctx context.Context, fields []graphql.CollectedField, v *Todo) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._marshalTodo(ctx, fields, v)
