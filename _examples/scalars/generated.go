...
func (ec *executionContext) _marshalAddress(ctx context.Context, fields []graphql.CollectedField, obj *model.Address) graphql.Marshaler {
...
func (ec *executionContext) marshalNUser2ᚕᚖgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋscalarsᚋmodelᚐUserᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.User) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, userImplementors)
	return ec._marshalNUser2ᚕᚖgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋscalarsᚋmodelᚐUserᚄWithFields(ctx, fields, v)
}

func (ec *executionContext) _marshalNUser2ᚕᚖgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋscalarsᚋmodelᚐUserᚄWithFields(ctx context.Context, fields []graphql.CollectedField, v []*model.User) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec._marshalNUser2ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋscalarsᚋmodelᚐUserWithFields(ctx, fields, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) _marshalNUser2ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋscalarsᚋmodelᚐUserWithFields(ctx context.Context, fields []graphql.CollectedField, v *model.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) _marshalOAddress2githubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋscalarsᚋmodelᚐAddressWithFields(ctx context.Context, fields []graphql.CollectedField, v model.Address) graphql.Marshaler {
...
func (ec *executionContext) _marshalOUser2ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋscalarsᚋmodelᚐUserWithFields(ctx context.Context, fields []graphql.CollectedField, v *model.User) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._marshalUser(ctx, fields, v)
